...
MongoDB.prototype.create = function(modelName, data, options, callback) {
  ...
  this.execute(modelName, 'insertOne', data, addOption({safe: true},
    options, 'checkKeys'), function(err, result) {
    if (self.debug) {
...
MongoDB.prototype.save = function(modelName, data, options, callback) {
  ...
  this.execute(modelName, 'updateOne', {_id: oid}, {$set: data}, addOption({upsert: true},
    options, 'checkKeys'), function(err, result) {
    if (!err) {
